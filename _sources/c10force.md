...
If the Earth exerts 5 N of force on a 500 g ball, and there are no other
forces involved, how much will the speed of the ball change in 1 s?
<form name="radioForm" action="#" method="get" id="choiceMyform25">
<input type="radio" name="question25" id="q25a1" value="a.">.01 m/s<br>
<input type="radio" name="question25" id="q25a2" value="b.">1 m/s<br>
